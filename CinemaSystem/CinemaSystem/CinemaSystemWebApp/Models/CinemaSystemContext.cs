...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=DESKTOP-PRU915R;Database=CinemaSystem;User Id=sa;Password=123456Sa");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Film>(entity =>
            {
                ...
                entity.HasMany(d => d.Categories)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("FilmId", "CategoryId").HasName("PK__FilmCate__CC8DB13EE80A892D");
            ...
            modelBuilder.Entity<Room>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__Room__737584F69370F2FF")
                    .IsUnique();
            ...
            modelBuilder.Entity<Ticket>(entity =>
            {
                entity.HasKey(e => new { e.ShowId, e.Row, e.Col })
                    .HasName("PK__Ticket__C18D1EE87176E2FD");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__User__A9D10534D51BD97A")
                    .IsUnique();
